...
public class visualizarReservasS {
	...
	private JFrame frmVisualizarReservasS;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmVisualizarReservasS.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public JFrame getFrmVisualizarReservas() {
		return this.frmVisualizarReservasS;
	}
	
	
	private void initialize() {
		frmVisualizarReservasS = new JFrame();
		frmVisualizarReservasS.setTitle("Visualizar Reservas");
		frmVisualizarReservasS.setBounds(100, 100, 700, 500);
		frmVisualizarReservasS.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		...
		ButtonCancelar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				frmVisualizarReservasS.dispose();
			}
		});
		...
		GroupLayout groupLayout = new GroupLayout(frmVisualizarReservasS.getContentPane());
		...
		frmVisualizarReservasS.getContentPane().setLayout(groupLayout);
