...
public class VistaCreacionActividades {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VistaCreacionActividades window = new VistaCreacionActividades();
	...
	private void initialize() {
		...
		LabelNombre.setBounds(10, 22, 65, 14);
		...
		TFieldNombre.setBounds(85, 22, 230, 20);
		...
		LabelPlazas.setBounds(10, 55, 65, 14);
		...
		SpinnerPlazas.setBounds(85, 53, 48, 20);
		...
		ControladorCreacionActividades CCA= new ControladorCreacionActividades(this);
