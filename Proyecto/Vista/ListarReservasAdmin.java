...
public class ListarReservasAdmin {
	...
	private JLabel hora;
	private JLabel lbl_id_socio;
	private JLabel id_socio;
	
	
	/**
	 * Create the application.
	 */
	public ListarReservasAdmin() {
		initialize();
	}
	...
	private void initialize() {
		...
		lbl_id_socio = new JLabel("ID Socio: ");
		lbl_id_socio.setFont(new Font("Tahoma", Font.PLAIN, 12));
		id_socio = new JLabel("");
		id_socio.setFont(new Font("Tahoma", Font.BOLD, 12));
		...
		detail_form.add(lbl_id_socio, "cell 0 4, growx");
		detail_form.add(id_socio, "cell 1 4, grow");
		...
		JPanel bottom_grid = new JPanel(new MigLayout("", "[][20px][]", "[15px][5px][45px]"));

		lbl_horas_reservadas = new JLabel();
		lbl_horas_reservadas.setFont(new Font("Tahoma", Font.PLAIN, 12));
		bottom_grid.add(lbl_horas_reservadas, "cell 0 0, span");
		...
		bottom_grid.add(btnCrearReserva, "cell 2 2, span, right");
		*/
	...
	public JLabel getLbl_id_socio() {
		return this.lbl_id_socio;
	}

	public JLabel getId_socio() {
		return this.id_socio;
	}

	public void setId_socio(String id_socio) {
		this.id_socio.setText(id_socio);
	}
