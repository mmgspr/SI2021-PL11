...
public class VistaMainSocio {
	...
	private void initialize() {
		...
		ReservasController reservas_controller = new ReservasController(new ReservasModel(), reservas, frame, /*TODO*/ 1);
		reservas_controller.initController();
		
		ActividadesView actividades = new ActividadesView();
		ActividadesController actividades_controller = new ActividadesController(new ActividadesModel(), actividades, frame, /*TODO*/ 1);
