...
public class ControladorPagoAdministracion {
	
	private VistaPagoAdministracion VPA;
	private VistaCreacionReservasAdministracion VRA;
	
	//Constructor
		public ControladorPagoAdministracion(VistaPagoAdministracion vp, VistaCreacionReservasAdministracion vc) {
			this.VPA=vp;
			this.VRA=vc;
			this.addListenerVPA();
			this.initView();
